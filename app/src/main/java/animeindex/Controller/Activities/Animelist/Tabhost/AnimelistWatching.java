...
public class AnimelistWatching extends ListActivity {
    ...
    public static String ANIME_WATCHING_TAG = "ANIMELISTWATCHING";
    @Override
        ...
        switch (requestCode){
            case EDIT_REQUEST_CODE:
                if(resultCode == RESULT_OK) {
                    editAnimelist((Animelist)data.getSerializableExtra(ANIME_WATCHING_TAG));
                    setAdapter();
                }
                else {
    ...
    public void onClick(ListView parent,
        ...
        ArrayList<Animelist> col = watchingArray;
        ...
        intent.putExtra(ANIME_WATCHING_TAG, col.get(position));
